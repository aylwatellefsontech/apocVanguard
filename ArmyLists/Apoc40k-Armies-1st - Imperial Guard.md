...
source: Apoc40k-Armies-1st - Imperial Guard.md
---

# Imperial Guard Army List

## Unit 1 — HQ — Lord Castellan Creed
...
| Name | Type | Range | A | SAP | SAT | Abilities |
| --- | --- | --- | --- | --- | --- | --- |
| Officer Weapons | Melee | Melee | User | 10+ | 11+ |  |

## Unit 5 — Elites — Enginseer
...
| Name | Type | Range | A | SAP | SAT | Abilities |
| --- | --- | --- | --- | --- | --- | --- |
| Laspistols | Small Arms | 12" | User | 8+ | 10+ |  |
| Close Combat Weapons | Melee | Melee | User | 8+ | 10+ |  |
...
### Options
- per: Per Unit
  text: Instead of 1 Multi-laser, this unit can be equipped with 1 Lascannon.
- per: Per Unit
...
| Adamantium Tracks | Melee | Melee | User | 7+ | 7+ |  |

## Unit 23 — Lord — Shadowsword
